...
Thursday, 06.05.2021, 19:30 onwards
...
We do have a talk this time (hopefully :-))
(Either a talk about asynch/await or CharlesProxy and manual testing)

We're using Jitsi, this time around as well. Please see the sidebar for the link to join in. (You need to RSVP to see this!)
...
to join our workspace 'cocoaheadshamburg.slack.com'
...
Social Video Links:
*will be posted to Slack and in the main meeting*
